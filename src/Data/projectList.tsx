...
export const projectList: Project[] = [
  {
    ...
    deployLink: 'https://ttolgaebi.com/',
    ...
    detailedDescriptions: [
      {
        ...
        contents: [
          {
            description: '기획, 일정 관리, 회의 리딩 등 프로젝트 전반 주도.',
          },
          {
            description:
          ...
          {
            description: '기능 통합 이슈 해결 및 팀원 간 협업 구조 조율.',
          },
        ],
      },
      {
        ...
        contents: [
          ...
          {
            description:
              'GitHub Actions를 이용해 main 브랜치 병합 시 자동 배포되는 CI/CD 파이프라인 구축.',
          },
          {
            description:
              'Express.js + Prisma ORM 조합으로 RESTful API 설계 및 구현.',
          },
          {
            description:
              'JWT 기반 인증/인가 시스템 구축 및 보안 강화 (CORS 세분화, 민감 경로 차단 등).',
          },
          {
            description:
              'Zod 라이브러리를 통해 API 입력 데이터 유효성 검사 체계화.',
          },
          {
            description:
              'Morgan 기반 파일 로깅 + Sentry 연동을 통한 실시간 에러 모니터링 시스템 구축.',
          },
        ],
      },
    ],
